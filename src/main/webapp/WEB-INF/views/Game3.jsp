...
<body class="body-12">
      ...
      <div class="full-width inner-container3 w-dyn-list">
        <div role="list" class="products inner-container4 w-dyn-items">
          ...
          <div data-w-id="6be50139-7c06-ee93-6d68-c7507f4c49b7" style="opacity:0" role="listitem" class="product-card-wrapper-c12y inner-container5-c12y w-dyn-item">
            <a href="<c:url value='/game/${items.id}' />" class="product-card-c12y inner-container6-c12y w-inline-block">
              ...
              <div class="product-card-price-c12y">${items.itemPrice}</div>
            </a>
          </div>
          </c:forEach>
        </div>
  ...
  <section class="foote189r-light-c777op">
    ...
    <div class="footer-bottom-2">
      ...
      <a href="#" class="footer-social-link-2 w-inline-block"><img src="/springdemo/images/face-removebg-preview.png" loading="lazy" width="96" alt="" class="image-38"></a>
      <a href="#" class="footer-social-link-2 w-inline-block"><img src="/springdemo/images/Twi-removebg-preview.png" loading="lazy" width="97" alt="" class="image-37"></a>
      <div class="footer-social-block-two">
        <a href="#" class="footer-social-link-2 w-inline-block"><img src="/springdemo/images/YT-removebg-preview.png" loading="lazy" width="93" alt="" class="image-39"></a>
      </div>
    </div>
  </section>
