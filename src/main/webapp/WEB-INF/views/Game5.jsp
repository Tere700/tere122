...
<head>
  ...
  <link href="/springdemo/css/5teams.css" rel="stylesheet" type="text/css">
  <link href="/springdemo/css/star.css" rel="stylesheet" type="text/css">
...
<body class="body-4">
    ...
    <div class="f-container-regular-4">
      ...
      <c:forEach var="review" items="${review}">
        <div id="w-node-ef221b94-00dc-2e98-cd27-d9fe5e75b67b-38526046" class="f-testimonial-outline-small">
          ...
          <h3 class="heading-33">${review.userName}</h3>
          <div class="f-testimonial-author">
            <div class="f-testimonial-avatar-small"><img src="${review.dataUri}" loading="lazy" alt="" class="f-avatar-image-2"></div>
          </div>
    ...
    <div class="nav-main">
      <div class="wrapper nav-bar-wrapper">
        <a href="index.html" class="brand w-nav-brand">
          <div><img src="/springdemo/images/LOGO.png" loading="lazy" width="214" sizes="(max-width: 479px) 55vw, 213.99307250976562px" alt="" srcset="/springdemo/images/LOGO-p-500.png 500w, /springdemo/images/LOGO.png 556w"></div>
        </a>
        <div class="navigation">
          <nav role="navigation" class="nav-menu w-nav-menu">
                ...
                <div>遊戲類別</div>
				 ...
				 <nav class="w-dropdown-list">
				    <c:forEach var="itemCat" items="${itemCategories}">
				        <a href="/springdemo/ItemCategory?category=${itemCat.categoryName}" class="dropdown-link w-dropdown-link w--current">${itemCat.categoryName}</a>
				    </c:forEach>
				</nav>
            </div>
            ...
            <div><img src="/springdemo/images/螢幕擷取畫面_2023-09-02__1_-removebg-preview-removebg-preview.png" loading="lazy" width="68" sizes="(max-width: 767px) 100vw, (max-width: 991px) 43.07291793823242px, (max-width: 1439px) 5vw, 67.98611450195312px" alt="" srcset="/springdemo/images/螢幕擷取畫面_2023-09-02__1_-removebg-preview-removebg-preview-p-500.png 500w, /springdemo/images/螢幕擷取畫面_2023-09-02__1_-removebg-preview-removebg-preview.png 552w"></div>
            <div data-hover="false" data-delay="0" class="dropdown w-dropdown">
              <div class="dropdown-toggle w-dropdown-toggle">
                <div class="icon w-icon-dropdown-toggle"></div>
                <div>會員中心</div>
  ...
  <section>
    ...
    <div class="w-form">
      <form  id="email-form"  modelAttribute="preReview" name="email-form" data-name="Email Form" method="post" class="form-7 form-9" data-wf-page-id="650071e17cd3c26438526046" data-wf-element-id="8cdaf3e1-8e67-7d25-6469-5ad8ad6847e1">
        <div>
        ...
        <textarea class="textarea-3 w-input" maxlength="5000" name="field" data-name="Field" placeholder="" id="field"></textarea>
  ...
  <section class="footer-light-c56489py">
    <div class="container">
      <div class="footer-wrapper-two">
        <a href="#" class="footer-brand-2 w-inline-block"><img src="/springdemo/images/LOGO.png" loading="lazy" width="253" sizes="(max-width: 479px) 88vw, 252.9861297607422px" alt="" srcset="/springdemo/images/LOGO-p-500.png 500w, /springdemo/images/LOGO.png 556w"></a>
    ...
    <div class="footer-bottom-2">
      ...
      <a href="#" class="footer-social-link-2 w-inline-block"><img src="/springdemo/images/face-removebg-preview.png" loading="lazy" width="96" alt="" class="image-35"></a>
      <a href="#" class="footer-social-link-2 w-inline-block"><img src="/springdemo/images/Twi-removebg-preview.png" loading="lazy" width="97" alt="" class="image-34"></a>
      <div class="footer-social-block-two">
        <a href="#" class="footer-social-link-2 w-inline-block"><img src="/springdemo/images/YT-removebg-preview.png" loading="lazy" width="93" alt="" class="image-36"></a>
      </div>
    </div>
  </section>
  ...
  <script src="/springdemo/js/star.js" type="text/javascript"></script>
</body>
</html>