...
<html data-wf-page="6503f66368763805040cc82b"
...
<link href="/springdemo/css/normalize.css" rel="stylesheet"
	type="text/css">
<link href="/springdemo/css/webflow.css" rel="stylesheet"
	type="text/css">
<link href="/springdemo/css/5teams-wondrous-site.webflow.css"
...
<link href="/springdemo/images/favicon.png" rel="shortcut icon"
	type="image/x-icon">
...
<body>
	<div class="preloader">
		<div class="loading-icon">
			<img src="/springdemo/images/preloader.gif" alt=""
			...
			<div class="nav-main">
				<div class="wrapper nav-bar-wrapper">
					<a href="/springdemo/index.html" class="brand w-nav-brand">
						<div>
							<img src="/springdemo/images/LOGO.png" loading="lazy" width="214"
								sizes="(max-width: 479px) 55vw, 213.99147033691406px" alt=""
								srcset="/springdemo/images/LOGO-p-500.png 500w, /springdemo/images/LOGO.png 556w">
						</div>
					</a>
					<div class="navigation">
						<nav role="navigation" class="nav-menu w-nav-menu">
							...
							<div data-hover="false" data-delay="0"
								...
								<nav class="w-dropdown-list">
									<a
										href="/springdemo/game-search-page/view-purchase-history-copy-3.html"
							...
							<a href="/springdemo/account-details/news-copy-2.html"
								class="nav-link w-nav-link">消息新聞</a>
							<div>
								<img
									src="/springdemo/images/螢幕擷取畫面_2023-09-02__1_-removebg-preview-removebg-preview.png"
									loading="lazy" width="68"
									sizes="(max-width: 991px) 100vw, (max-width: 1439px) 5vw, 67.99715423583984px"
									alt=""
									srcset="/springdemo/images/螢幕擷取畫面_2023-09-02__1_-removebg-preview-removebg-preview-p-500.png 500w, /springdemo/images/螢幕擷取畫面_2023-09-02__1_-removebg-preview-removebg-preview.png 552w">
							</div>
							<div data-hover="false" data-delay="0"
								class="dropdown w-dropdown">
								<div class="dropdown-toggle w-dropdown-toggle">
								...
								<nav class="w-dropdown-list">
									<a href="/springdemo/member-profile/member-profile.html"
										class="dropdown-link w-dropdown-link">個人資料</a> <a
										href="/springdemo/member-profile/friend-list.html"
										class="dropdown-link-2 w-dropdown-link">好友</a> <a
										href="/springdemo/member-profile/game-library.html"
										class="dropdown-link-3 w-dropdown-link">遊戲庫</a> <a
										href="/springdemo/account-details/coupon.html"
										aria-current="page"
										class="dropdown-link-4 w-dropdown-link w--current">我的優惠卷</a> <a
										href="/springdemo/account-details/viewpurchasehistory.html"
										class="dropdown-link-5 w-dropdown-link">檢視購買記錄</a>
								</nav>
							</div>
							<a href="/springdemo/login-register/model2.html"
								class="nav-link w-nav-link">註冊</a> <a
								href="/springdemo/login-register/loginpage.html"
						...
						<div data-node-type="commerce-cart-wrapper" data-open-product=""
							...
							<a href="#" data-node-type="commerce-cart-open-link"
								...
								src="/springdemo/images/cart-icon.svg" alt="" class="cart-icon">
			...
			<div class="con99py">
				...
				<div class="team-grid">
					<c:forEach var="coupon" items="${coupons}">
						<div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf4701df-040cc82b"
							class="team-card">
							<img
								src="@{'data:image/png;base64,' + ${discountTypeImages.get(coupon.discount_type)}}?timestamp=${System.currentTimeMillis()}"
								loading="lazy" alt="Discount Image" class="team-member-image">
							<div class="team-member-name">${coupon.discount_type}</div>
							<div class="team-member-position">${coupon.discount_type}<br>
								不得與其他折價優惠同時使用。
							</div>
							<p class="paragraph-4">${coupon.valid_from}到<br>${coupon.valid_to}前有效</p>
						</div>
					</c:forEach>

					<div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf4701ea-040cc82b"
						class="team-card">
						<img
							src="/springdemo/images/372600610_797590695442758_7915769027370116754_n-removebg-preview.png"
							loading="lazy" alt="" class="team-member-image">
						<div class="team-member-name">返校折價66%</div>
						<div class="team-member-position">
							返校折價優惠66%<br>不得與其他折價優惠同時使用。
						</div>
						<p class="paragraph-5">到2023/10/31, 12:00:00PM前有效</p>
					</div>
					<div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf4701f4-040cc82b"
						class="team-card">
						<img
							src="/springdemo/images/372674854_290450316951089_5584595248934136422_n-removebg-preview.png"
							loading="lazy" alt="" class="team-member-image">
						<div class="team-member-name">返校折價66%</div>
						<div class="team-member-position">
							返校折價優惠66%<br>不得與其他折價優惠同時使用。
					...
					<div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf4701fe-040cc82b"
						class="team-card">
						<img
							src="/springdemo/images/372551420_1434925397363359_7510774798186496179_n-removebg-preview.png"
							loading="lazy" alt="" class="team-member-image">
						<div class="team-member-name">返校折價66%</div>
						<div class="team-member-position">
							返校折價優惠66%<br>不得與其他折價優惠同時使用。
					...
					<div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf470208-040cc82b"
						class="team-card">
						<img
							src="/springdemo/images/372919840_2136606510004716_7751145998842007823_n-removebg-preview.png"
							loading="lazy" alt="" class="team-member-image">
						<div class="team-member-name">返校折價66%</div>
						<div class="team-member-position">
							返校折價優惠66%<br>不得與其他折價優惠同時使用。
					...
					<div id="w-node-_2e76f9aa-ea3b-ae1c-67d7-64cddf470212-040cc82b"
						class="team-card">
						<img
							src="/springdemo/images/373460329_841788514013942_6064721930173980859_n-removebg-preview.png"
							loading="lazy" alt="" class="team-member-image">
						<div class="team-member-name">返校折價66%</div>
						<div class="team-member-position">
							返校折價優惠66%<br>不得與其他折價優惠同時使用。
		...
		<section class="footer-light-co15816py">
			<div class="container">
				<div class="footer-wrapper-two">
					<a href="#" class="footer-brand-2 w-inline-block"><img
						src="/springdemo/images/LOGO.png" loading="lazy" width="253"
						sizes="(max-width: 479px) 88vw, 252.9971466064453px" alt=""
						srcset="/springdemo/images/LOGO-p-500.png 500w, /springdemo/images/LOGO.png 556w"></a>
					...
					<div class="footer-form w-form">
						<form id="wf-form-Footer-Form" name="wf-form-Footer-Form"
							...
							data-wf-page-id="6503f66368763805040cc82b"
							data-wf-element-id="c4bd483b-2037-1d4e-3dd3-6bef3b460033">
							<div class="footer-title">Subscribe</div>
							<div class="footer-form-block">
								<input type="email" class="footer-form-field w-input"
									maxlength="256" name="Footer-Email-2"
									data-name="Footer Email 2" aria-label="Get product updates"
			...
			<div class="footer-bottom-2">
				...
				<a href="#" class="footer-social-link-2 w-inline-block"><img
					src="/springdemo/images/face-removebg-preview.png" loading="lazy"
					width="96" alt="" class="image-41"></a> <a href="#"
					class="footer-social-link-2 w-inline-block"><img
					src="/springdemo/images/Twi-removebg-preview.png" loading="lazy"
					width="97" alt="" class="image-40"></a>
				<div class="footer-social-block-two">
					<a href="#" class="footer-social-link-2 w-inline-block"><img
						src="/springdemo/images/YT-removebg-preview.png" loading="lazy"
						width="93" alt=""></a>
				</div>
			</div>
		</section>
